...
```bash
$ # Get the code
$ git clone https://github.com/app-generator/priv-flask-dashboard-gradient-pro.git
$ cd priv-flask-dashboard-gradient-pro
$
...
---
[Flask Gradient PRO](https://appseed.us/admin-dashboards/flask-dashboard-gradient-pro) - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
